      ...
      <View style={{ flex: 1 }}>
        ...
        <View style={{ flex: 5, alignItems: 'center' }}>
          {img_source ? <Image source={{ uri: img_source }} style={{ width: 240, height: 140, margin: 15 }} /> :
            <View style={styles.viewStyleImg}>
          ...
          <View>
            <TextInput placeholder='Nhập tên sản phẩm' style={styles.textinput} onChangeText={(txt) => setNameProduct(txt)} />
            <TextInput placeholder='Nhập giá sản phẩm' style={styles.textinput} onChangeText={(txt) => setPriceProduct(txt)} />
